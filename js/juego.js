...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 166, 110, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 136, 110, 30, 30, 1),
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    if (typeof tecla !== 'undefined') {
      this.jugador.cambiarSpriteDireccion(tecla);
    }
  }
};
